<div class="custom-controls-stacked row align-items-center m-0">
    <label class="custom-control custom-checkbox  col">
        ...
        <span class="custom-control-label">
            <img class="fix-icons-radio" src=" {{asset('storage/default_images/default_icons/category-1.svg')}} "
                alt="cat1">
        </span>
    </label>
    <label class="custom-control custom-checkbox  col">
        <input wire:model.defer='default_icon' value="default_icons/category-2.svg" type="checkbox"
            class="custom-control-input check-one check-one2">
        <span class="custom-control-label">
            <img class="fix-icons-radio" src=" {{asset('storage/default_images/default_icons/category-2.svg')}} "
                alt="cat1">
        </span>
    </label>
    <label class="custom-control custom-checkbox  col">
        <input wire:model.defer='default_icon' value="default_icons/category-3.svg" type="checkbox"
            class="custom-control-input check-one check-one2">
        <span class="custom-control-label">
            <img class="fix-icons-radio" src=" {{asset('storage/default_images/default_icons/category-3.svg')}} "
                alt="cat1">
        </span>
    </label>
    <label class="custom-control custom-checkbox  col">
        <input wire:model.defer='default_icon' value="default_icons/category-4.svg" type="checkbox"
            class="custom-control-input check-one check-one2">
        <span class="custom-control-label">
            <img class="fix-icons-radio" src=" {{asset('storage/default_images/default_icons/category-4.svg')}} "
                alt="cat1">
        </span>
    </label>
    <label class="custom-control custom-checkbox  col">
        <input wire:model.defer='default_icon' value="default_icons/category-5.svg" type="checkbox"
            class="custom-control-input check-one check-one2">
        <span class="custom-control-label">
            <img class="fix-icons-radio" src=" {{asset('storage/default_images/default_icons/category-5.svg')}} "
                alt="cat1">
        </span>
    </label>
...
<div class="custom-controls-stacked row align-items-center m-0">
    <label class="custom-control custom-checkbox  col">
        <input wire:model.defer='default_icon' value="default_icons/category-6.svg" type="checkbox"
            class="custom-control-input check-one check-one2" value="option1">
        <span class="custom-control-label">
            <img class="fix-icons-radio" src=" {{asset('storage/default_images/default_icons/category-6.svg')}} "
                alt="cat1">
        </span>
    </label>
    <label class="custom-control custom-checkbox  col">
        <input wire:model.defer='default_icon' value="default_icons/category-7.svg" type="checkbox"
            class="custom-control-input check-one check-one2">
        <span class="custom-control-label">
            <img class="fix-icons-radio" src=" {{asset('storage/default_images/default_icons/category-7.svg')}} "
                alt="cat1">
        </span>
    </label>
    <label class="custom-control custom-checkbox  col">
        <input wire:model.defer='default_icon' value="default_icons/category-8.svg" type="checkbox"
            class="custom-control-input check-one check-one2">
        <span class="custom-control-label">
            <img class="fix-icons-radio" src=" {{asset('storage/default_images/default_icons/category-8.svg')}} "
                alt="cat1">
        </span>
    </label>
    <label class="custom-control custom-checkbox  col">
        <input wire:model.defer='default_icon' value="default_icons/category-9.svg" type="checkbox"
            class="custom-control-input check-one check-one2">
        <span class="custom-control-label">
            <img class="fix-icons-radio" src=" {{asset('storage/default_images/default_icons/category-9.svg')}} "
                alt="cat1">
        </span>
    </label>
    <label class="custom-control custom-checkbox  col">
        <input wire:model.defer='default_icon' value="default_icons/category-10.svg" type="checkbox"
            class="custom-control-input check-one check-one2">
        <span class="custom-control-label">
            <img class="fix-icons-radio" src=" {{asset('storage/default_images/default_icons/category-10.svg')}} "
                alt="cat1">
        </span>
    </label>
...
<div class="custom-controls-stacked row align-items-center m-0">
    <label class="custom-control custom-checkbox  col">
        <input wire:model.defer='default_icon' value="default_icons/icon-1.svg" type="checkbox"
            class="custom-control-input check-one check-one2" value="option1">
        <span class="custom-control-label">
            <img class="fix-icons-radio" src=" {{asset('storage/default_images/default_icons/icon-1.svg')}} "
                alt="cat1">
        </span>
    </label>
    <label class="custom-control custom-checkbox  col">
        <input wire:model.defer='default_icon' value="default_icons/icon-2.svg" type="checkbox"
            class="custom-control-input check-one check-one2">
        <span class="custom-control-label">
            <img class="fix-icons-radio" src=" {{asset('storage/default_images/default_icons/icon-2.svg')}} "
                alt="cat1">
        </span>
    </label>
    <label class="custom-control custom-checkbox  col">
        <input wire:model.defer='default_icon' value="default_icons/icon-3.svg" type="checkbox"
            class="custom-control-input check-one check-one2">
        <span class="custom-control-label">
            <img class="fix-icons-radio" src=" {{asset('storage/default_images/default_icons/icon-3.svg')}} "
                alt="cat1">
        </span>
    </label>
    <label class="custom-control custom-checkbox  col">
        <input wire:model.defer='default_icon' value="default_icons/icon-4.svg" type="checkbox"
            class="custom-control-input check-one check-one2">
        <span class="custom-control-label">
            <img class="fix-icons-radio" src=" {{asset('storage/default_images/default_icons/icon-4.svg')}} "
                alt="cat1">
        </span>
    </label>
    <label class="custom-control custom-checkbox  col">
        <input wire:model.defer='default_icon' value="default_icons/icon-5.svg" type="checkbox"
            class="custom-control-input check-one check-one2">
        <span class="custom-control-label">
            <img class="fix-icons-radio" src=" {{asset('storage/default_images/default_icons/icon-5.svg')}} "
                alt="cat1">
        </span>
    </label>
</div>

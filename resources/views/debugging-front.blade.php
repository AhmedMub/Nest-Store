...
<body>
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right">
                            <ul>
                                ...
                                <li>
                                    <a class="language-dropdown-active" href="#"><i class="fi-rs-angle-small-down"></i>
                                        English</a>
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a href="shop-product-right.html">Seeds of Change Organic Quinoe Naturel</a>
                                    </h2>
    ...
    {{-- Template JS --}}
    <script src="{{asset('frontend/js/main.js?v=4.0')}}"></script>

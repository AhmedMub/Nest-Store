                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li><a href=" {{url('/testing2')}} " class="slide-item active"> Cards design</a>
                                    </li>
    ...
    <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
        <div class="detail-gallery">
            ...
            <div class="slider-nav-thumbnails">
                <div><img src="{{$product->getFirstMediaUrl('mainImage')}}" alt="product image" /></div>
                @foreach ($product->getMedia('multiImages') as $item)
                <div><img src="{{$item->getUrl()}}" alt="product image" /></div>
                @endforeach
            </div>
        ...
        <div class="detail-info pr-30 pl-30">
            ...
            <div class="clearfix product-price-cover">
                <div class="product-price primary-color float-left">
                    ...
                    <span class="current-price text-brand">{{$product->productDiscount->discounted_price}}</span>
                    <span>
                        <span class="save-price font-md color3 ml-15">%{{$product->productDiscount->discount_percent}}
                            Off</span>

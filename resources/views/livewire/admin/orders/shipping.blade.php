<div class="card">
    <div class="card-header">
        <h3 class="card-title text-capitalize">Shipping orders List</h3>
    </div>
    <div class="card-body">
                ...
                <div class="row justify-content-between m-0">
                    <div class="col-sm-12 col-md-5">
                        ...
                        <button data-bs-target="#modaldemo5" data-bs-toggle="modal" data-bs-original-title="Delete"
                            ...
                            <span class="bi bi-check2-circle fs-16 me-2"></span>delivered
                            selected
                        </button>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered text-center" role="document">
            <div class="modal-content tx-size-sm">
                <div class="modal-body text-center p-4 pb-5">
                    ...
                    <h4 class="h4 mb-0 mt-3">Delivered!</h4>
                    <p class="mb-4 mx-4">Are you sure of the delivered selected orders?</p>
...
<script>
    window.addEventListener('swal:confirm', event => {
        swal({
            ...
            if(confirmed) {
                Livewire.emit('deliverOrders', event.detail.id);
            }
        });
    });
    window.addEventListener('swal:confirmDelete', event => {
        swal({
            ...
            if(confirmed) {
                Livewire.emit('deletedDeliver', event.detail.id);
            }
        });
    });
</script>

<div class="card">
    <div class="card-header">
        <h3 class="card-title text-capitalize">Confirm orders List</h3>
    </div>
    <div class="card-body">
        ...
        <div class="modal-dialog modal-dialog-centered text-center" role="document">
            <div class="modal-content tx-size-sm">
                <div class="modal-body text-center p-4 pb-5">
                    ...
                    <p class="mb-4 mx-4">Are you sure process selected orders?</p>
...
<script>
    window.addEventListener('swal:confirm', event => {
        swal({
            ...
            if(confirmed) {
                Livewire.emit('processOrder', event.detail.id);
            }
        });
    });
    window.addEventListener('swal:confirmDelete', event => {
        swal({
            ...
            if(confirmed) {
                Livewire.emit('deletedProcessed', event.detail.id);
            }
        });
    });
</script>

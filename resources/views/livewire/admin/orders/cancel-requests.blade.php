<div class="card">
    <div class="card-header">
        <h3 class="card-title text-capitalize">customer cancel requests</h3>
    </div>
    <div class="card-body">
                ...
                <div class="row justify-content-between m-0">
                    <div class="col-sm-12 col-md-5">
                        ...
                        <button data-bs-target="#modaldemo5" data-bs-toggle="modal" data-bs-original-title="Delete"
                            ...
                            <span class="bi bi-trash fs-16 me-2"></span>cancel
                            selected
                        </button>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered text-center" role="document">
            <div class="modal-content tx-size-sm">
                <div class="modal-body text-center p-4 pb-5">
                    ...
                    <h4 class="h4 mb-0 mt-3">Cancel!</h4>
                    <p class="mb-4 mx-4">Are you sure of the cancel selected orders?</p>
                    <button wire:click.prevent='selectedOrders' aria-label="Close"
                        class="btn btn-danger pd-x-25 pd-x-25" data-bs-dismiss="modal">Continue</button>
...
<script>
    window.addEventListener('swal:confirmDelete', event => {
        swal({
            ...
            if(confirmed) {
                Livewire.emit('cancelConfirmedOrders', event.detail.id);
            }
        });
    });
</script>

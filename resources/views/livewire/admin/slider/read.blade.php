        ...
        <div class="table-responsive">
            <table class="table table-bordered border text-nowrap mb-0" id="basic-edit">
                ...
                <thead class="table-primary">
                    <tr class="text-center">
                        ...
                        <th class="wd-15p border-bottom-0 text-capitalize">image</th>
                        <th wire:click="sortBy('title_en')"
                        ...
                        <th class="wd-15p border-bottom-0 text-capitalize">slider title Ar</th>
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        <td><input wire:model='selectedCheckboxes' value="{{$slider->id}}" type="checkbox"></td>
                        <td>
                            <div>
                                <img src=" {{$slider->getFirstMediaUrl('slider', 'thumb')}} " class="customWidthSlider"
                                    alt="slider">
                            </div>
                        </td>
                        ...
                        <td>
                            <livewire:admin.slider.status :slider="$slider" :name="'status'"
                                :key="'status'.$slider->id" />
                        </td>
                        <td>
            ...
            <div>
                <p>
                    ...
                    showing {{$sliders->firstItem()}} to {{$sliders->lastItem()}} out of
                    {{$sliders->total()}}
                </p>
                <p>

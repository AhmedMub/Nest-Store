<div class="card">
    <div class="card-header">
        <h3 class="card-title text-capitalize">district list</h3>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered border text-nowrap mb-0" id="basic-edit">
                    ...
                    <div class="col-sm-12 col-md-4 align-self-center">
                        <div class="main-header-center ms-3 d-none d-lg-block">
                            <input wire:model.debounce.300ms='search' class="form-control w-100"
                                placeholder="Search for country and district" type="search">
                ...
                <thead class="table-primary">
                    <tr class="text-center">
                        ...
                        <th class="wd-15p border-bottom-0 text-capitalize">country</th>
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        <td><input wire:model='selectedCheckboxes' value="{{$district->id}}" type="checkbox"></td>
                        <td>{{$district->countryDistricts->country}}</td>
                        <td>{{$district->district}}</td>
                        <td>
                            <livewire:admin.shippingdistrict.status :district="$district" :name="'status'"
                        ...
                        <td>
                            <div class=" d-flex justify-content-center g-2">
                                <a wire:click="$emit('edit',{{$district->id}})"
                                ...
                                <a wire:click="$emit('delete',{{$district->id}})"
            ...
            <div>
                <p>
                    ...
                    showing {{$districts->firstItem()}} to {{$districts->lastItem()}} out of
                    {{$districts->total()}}
                </p>
                <p>

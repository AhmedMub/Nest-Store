<div class="card">
    <div class="card-header">
        <h3 class="card-title">Product Tags List</h3>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered border text-nowrap mb-0" id="basic-edit">
                ...
                <tbody>
                    @foreach ($productsDiscount as $prDiscount)
                    <tr class="text-center">
            ...
            <div>
                <p>
                    ...
                    showing {{$productsDiscount->firstItem()}} to {{$productsDiscount->lastItem()}} out of
                    {{$productsDiscount->total()}}
                </p>
                <p>
                    {{-- this is to declare the pagenation --}}
                    {{$productsDiscount->links()}}
                </p>
            </div>
        </div>
    </div>

    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h5 class="fw-bold modal-title text-capitalize">edit selected country</h5><button aria-label="Close"
            ...
            <form method="POST" wire:submit.prevent='update'>
                ...
                <div class="modal-body card-body py-2">
                    <div wire:ignore class="form-group">
                        <label class="text-capitalize form-label mt-0" for="editCountry">country name</label>
                        <select autocomplete="off" class="form-select" id="editCountry">

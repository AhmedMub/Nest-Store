                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p class="">With supporting text below as a natural lead-in to additional
                                            content.</p>
                            ...
                            <div class="col-md-12 col-xl-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        a, tellus. Phasellus viverra nulla ut metus varius laoreet </div>
                                    <div class="card-footer">
                        ...
                        <div class="row ">
                                        ...
                                        <div class="visitor-list">
                                            ...
                                            <div class="media mt-2">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <p class="text-muted mb-0">Submitted the project schedule to the
                                                        manager</p>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-xl-4 col-md-12">
                                <div class="card m-b-20">
                                    ...
                                    <div class="card-body">
                                        <p>Put toy mouse in food bowl run out of litter box at full speed drool but pee
                                            in Put toy mouse Put toy mouse the shoe purr when being pet but chew foot.
                                        </p>
                                        <p class="mb-0">Scratch the postman wake up lick paw Duis aute irure dolor in
                                            reprehenderit wake up owner meow meow lick plastic bags Scratch the postman
                                            wake up lick paw wake Duis aute irure dolor having their mate disturbing
                                            sleeping
                                            humans.
                                        </p>
                                    </div>
                                ...
                                <div class="card d-flex m-b-20">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="mb-0">Duis aute irure dolor in reprehenderit in voluptate velit
                                            Scratch the postman wake up lick paw wake up owner meow meow lick plastic
                                            bags Scratch the postman wake up lick paw wake having their mate disturbing
                                            sleeping
                                            humans.
                                        </p>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="row g-0">
                                        <div class="col-md-4 pe-3 pe-md-0">
                                            <img src="../assets/images/media/22.jpg" class="card-img-left h-100"
                                                alt="img">
                                        </div>
                                ...
                                <div class="card">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-4 ps-3 ps-md-0">
                                            <img src="../assets/images/media/22.jpg" class="card-img-right h-100"
                                                alt="img">
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="tab-menu-heading tab-menu-heading-boxed">
                                                <div class="tabs-menu-boxed">
                                                    ...
                                                    <ul class="nav panel-tabs fs-14">
                                                        <li><a href="#activetabs" class="active"
                                                                data-bs-toggle="tab">Active</a></li>
                                                        <li><a href="#linktabs" data-bs-toggle="tab">Link</a></li>
                                                        <li><a class="disable" href="#disabletabs"
                                                                data-bs-toggle="tab">Disabled</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <ul class="nav nav-pills card-header-pills">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-bs-toggle="tab"
                                                    href="#activepills">Active</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-bs-toggle="tab" href="#linkpills">Link</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link disabled" data-bs-toggle="tab" href="#disablepills"

{{-- //TODO should have to x comp for billing details one for auth user and one for guest user --}}
        ...
        <div class="row">
            <div class="col-lg-8 mb-40">
                ...
                <div class="d-flex justify-content-between">
                    <h6 class="text-body">{{__('frontend/checkout.There are')}} <span class="text-brand">3</span>
                    ...
                    <div class="col-lg-6 mb-sm-15 mb-lg-0 mb-md-3">
                        ...
                        <div class="toggle_info">
                            <span><i class="fi-rs-user mr-10"></i><span class="text-muted font-lg">
                                    {{__('frontend/checkout.Already have an account?')}}</span> <a href="#loginform"
                        ...
                        <div class="panel-collapse collapse login_form" id="loginform">
                            <div class="panel-body">
                                <p class="mb-30 font-sm">
                                    ...
                                    yourdetails below. If you are a new customer, please proceed to the Billing &amp
                                    Shipping section.
                                </p>
                                <form method="POST" action="{{ route('login')}}">
                                    ...
                                    <div class="form-group">
                                        <input class="{{ $errors->has('password') ? ' form-control is-invalid' : '' }}"

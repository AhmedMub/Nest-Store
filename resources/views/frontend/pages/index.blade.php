                        ...
                        <ul>
                            <li>
                                <a href="shop-grid-right.html"> <img
                                        src={{asset("frontend/assets/imgs/theme/icons/category-1.svg")}} alt="" />Milks
                                    and Dairies</a>
                            </li>
                            <li>
                                <a href="shop-grid-right.html"> <img
                            ...
                            <li>
                                <a href="shop-grid-right.html"> <img
                                        src={{asset("frontend/assets/imgs/theme/icons/category-4.svg")}} alt="" />Baking
                                    material</a>
                            </li>
                            <li>
                                <a href="shop-grid-right.html"> <img
                                        src={{asset("frontend/assets/imgs/theme/icons/category-5.svg")}} alt="" />Fresh
                                    Fruit</a>
                            </li>
                            <li>
                                <a href="shop-grid-right.html"> <img
                                        src={{asset("frontend/assets/imgs/theme/icons/category-6.svg")}} alt="" />Wines
                                    & Drinks</a>
                            </li>
                            <li>
                                <a href="shop-grid-right.html"> <img
                                        src={{asset("frontend/assets/imgs/theme/icons/category-7.svg")}} alt="" />Fresh
                                    Seafood</a>
                            </li>
                            <li>
                                <a href="shop-grid-right.html"> <img
                            ...
                            <li>
                                <a href="shop-grid-right.html"> <img
                                        src={{asset("frontend/assets/imgs/theme/icons/category-10.svg")}} alt="" />Bread
                                    and Juice</a>
                            </li>
                            <li>
                                <a href="shop-grid-right.html"> <img
                    ...
                    <div class="more_slide_open" style="display: none">
                        <div class="d-flex categori-dropdown-inner">
                            <ul>
                                <li>
                                    <a href="shop-grid-right.html"> <img
                                            src={{asset("frontend/assets/imgs/theme/icons/icon-1.svg")}} alt="" />Milks
                                        and Dairies</a>
                                </li>
                                <li>
                                    <a href="shop-grid-right.html"> <img
                                ...
                                <li>
                                    <a href="shop-grid-right.html"> <img
                                            src={{asset("frontend/assets/imgs/theme/icons/icon-3.svg")}} alt="" />Wines
                                        & Drinks</a>
                                </li>
                                <li>
                                    <a href="shop-grid-right.html"> <img
                                            src={{asset("frontend/assets/imgs/theme/icons/icon-4.svg")}} alt="" />Fresh
                                        Seafood</a>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="carausel-10-columns-cover position-relative">
            <div class="carausel-10-columns" id="carausel-10-columns">
                ...
                <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay="0s">
                    <figure class="img-hover-scale overflow-hidden">
                        <a href="shop-grid-right.html"><img src={{asset("frontend/assets/imgs/shop/cat-15.png")}}
                                alt="" /></a>
                    </figure>
                ...
                <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                    ...
                    <div class="product-content-wrap">
                        ...
                        <div class="deals-content">
                            <h2><a href="shop-product-right.html">Seeds of Change Organic Quinoa, Brown, & Red Rice</a>
                            </h2>
                            <div class="product-rate-cover">
                                <div class="product-rate d-inline-block">
                                    <div class="product-rating" style="width: 90%"></div>

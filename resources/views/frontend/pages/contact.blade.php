        ...
        <div class="container">
            <div class="breadcrumb">
                <a href="{{route('home')}}" rel="nofollow"><i
                        class="fi-rs-home mr-5"></i>{{__('frontend/contact.Home')}}</a>
                <span></span> {{__('frontend/contact.Pages')}} <span></span>
                {{__('frontend/contact.Contact Us')}}
            </div>
        </div>
    </div>

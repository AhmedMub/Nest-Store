        ...
        <div class="container">
            <div class="breadcrumb">
                <a href="{{route('home')}}" rel="nofollow"><i
                        class="fi-rs-home mr-5"></i>{{__('frontend/about.Home')}}</a>
                <span></span> {{__('frontend/about.Pages')}} <span></span> {{__('frontend/about.About us')}}
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-xl-10 col-lg-12 m-auto">
                    <section class="row align-items-center mb-50">
                        <div class="col-lg-6">
                            <img src="{{asset('frontend/assets/defaultImages/about-1.png')}}" alt=""
                            ...
                            <div class="pl-25">
                                ...
                                <div class="carausel-3-columns-cover position-relative">
                                    ...
                                    <div class="carausel-3-columns" id="carausel-3-columns">
                                        <img src="{{asset('frontend/assets/defaultImages/about-2.png')}}" alt="" />
                                        <img src="{{asset('frontend/assets/defaultImages/about-3.png')}}" alt="" />
                                        <img src="{{asset('frontend/assets/defaultImages/about-4.png')}}" alt="" />
                                        <img src="{{asset('frontend/assets/defaultImages/about-2.png')}}" alt="" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <section class="row align-items-center mb-50">
                        <div class="row mb-50 align-items-center">
                            <div class="col-lg-7 pr-30">
                                <img src="{{asset('frontend/assets/defaultImages/about-5.png')}}" alt=""
                            ...
                            <div class="col-lg-8">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="team-card">
                                            <img src="{{asset('frontend/assets/defaultImages/about-6.png')}}" alt="" />
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="team-card">
                                            <img src="{{asset('frontend/assets/defaultImages/about-8.png')}}" alt="" />
                                            <div class="content text-center">

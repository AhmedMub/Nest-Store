                    ...
                    <div class="col-xl-3">
                        ...
                        <div class="breadcrumb">
                            <a href="{{route('home')}}" rel="nofollow"><i
                                    class="fi-rs-home mr-5"></i>{{__('frontend/productsByCategory.Home')}}</a>
                            <span></span> {{__('frontend/productsByCategory.Shop')}} <span></span>{{$tag->name}}
                        </div>
                    </div>
            ...
            <div class="col-12">
                <div class="shop-product-fillter">
                    <div class="totall-product">
                        <p>{{__('frontend/productsByCategory.We found')}}<strong
                                class="text-brand">29</strong>{{__('frontend/productsByCategory.items for you!')}}</p>
                    </div>

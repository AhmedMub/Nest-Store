                        ...
                        <td class="header"
                            ...
                            <a href="http://nest.test"
                                ...
                                <img src="{{asset('frontend/assets/imgs/theme/logo.svg')}}" class="logo"
                                    alt="Laravel Logo"
                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; border: none;">
                            </a>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            Please be informed that your account has been created your credentials as
                                            below:</br></br>
                                            Name: {{$credentials[0] . " " . $credentials[1]}}</br>
                                            Phone number: {{$credentials[3]}}</br>
                                            Email: {{$credentials[2]}}</br>
                                            Password: {{$credentials[4]}}</br>
                                        </p>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © {{date('Y')}} Nest Mart & Grocery. All rights reserved.</p>

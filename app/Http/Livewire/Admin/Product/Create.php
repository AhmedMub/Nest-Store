...
class Create extends Component
{
    ...
    protected $rules = [
        ...
        'name_en' => ['required', 'string', 'unique:products', 'regex:/^[^<>()*?=%_${}#:;@![\]{}\/]+$/i'],
        'name_ar' => ['required', 'string', 'unique:products', 'regex:/^[^<>()*?=%_${}#:;@![\]{}\/]+$/ii'],
        'qty' => ['required', 'integer', 'regex:/^[^<>()*?=%_${}#:;@![\]{}\/]+$/i'],
        'price' => ['required', 'integer', 'regex:/^[^<>()*?=%_${}#:;@![\]{}\/]+$/i'],
        'type' => ['required', 'string', 'regex:/^[^<>()*?=%_${}#:;@![\]{}\/]+$/i'],
        'size' => ['nullable', 'integer', 'regex:/^[^<>()*?=%_${}#:;@![\]{}\/]+$/i'],
        'mfg' => ['required', 'date_format:Y-m-d'],
        'exp' => ['required', 'date_format:Y-m-d'],
        'short_desc_en' => ['string', 'regex:/^[^<>()*?=%_${}#:;@![\]{}\/]+$/i'],
        'short_desc_ar' => ['string', 'regex:/^[^<>()*?=%_${}#:;@![\]{}\/]+$/i'],
        ...
        'stand_up_en' => ['nullable', 'string', 'regex:/^[^<>()*?=%_${}#:;@![\]{}\/]+$/i'],
        'stand_up_ar' => ['nullable', 'string', 'regex:/^[^<>()*?=%_${}#:;@![\]{}\/]+$/i'],
        'folded_en' => ['nullable', 'string', 'regex:/^[^<>()*?=%_${}#:;@![\]{}\/]+$/i'],
        'folded_ar' => ['nullable', 'string', 'regex:/^[^<>()*?=%_${}#:;@![\]{}\/]+$/i'],
        'frame_en' => ['nullable', 'string', 'regex:/^[^<>()*?=%_${}#:;@![\]{}\/]+$/i'],
        'frame_ar' => ['nullable', 'string', 'regex:/^[^<>()*?=%_${}#:;@![\]{}\/]+$/i'],
        'color_en' => ['nullable', 'string', 'regex:/^[^<>()*?=%_${}#:;@![\]{}\/]+$/i'],
        'color_ar' => ['nullable', 'string', 'regex:/^[^<>()*?=%_${}#:;@![\]{}\/]+$/i'],
        'size_en' => ['nullable', 'string', 'regex:/^[^<>()*?=%_${}#:;@![\]{}\/]+$/i'],
